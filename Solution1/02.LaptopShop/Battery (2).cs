...
namespace _02.LaptopShop
{
    class Battery
    {
        ...
        public override string ToString()
        {
            ...
            sb.AppendLine(string.Format("Number of cells {0}-cells", this.BatteryCells));
            sb.AppendLine(string.Format("Max power: {0} mAh", this.BatteryPower));
            sb.AppendLine(string.Format("Max life: {0} hours", this.BatteryLife));
            return sb.ToString();
        }
    }
}
